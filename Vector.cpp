...
int main()
{
    ...
    {
        int choice;
        cout << endl <<"Enter The Operation To Be Held" << endl;


        cin >> choice;
        switch(choice)
        {
            case 1: vm.AddLast();break;
            case 2: cout << vm.DeleteLast() << " Is Deleted"; break;
            case 3: vm.Insert();break;
            case 4: vm.EraseFrom();break;
            case 5: cout << "Size : " << vc.Size();         break;
            case 6: vc.IsEmpty();      break;
            case 7: vc.Resize();       break;
            case 8: vm.ValuesAssign(); break;
            case 9: vm.Clear();        break;
            case 10:cout << "Capacity : " << vc.Capacity();     break;
            case 11: vm.Display();       break;
            case 12: n=1;
        }
        n--;
    }
